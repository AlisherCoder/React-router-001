...
const About = () => {
   return (
      <section className="">
         <div className="grid grid-cols-1 container gap-12 py-[128px] md:grid-cols-2 ">
         ...
         <div className="container mb-[128px]">
            <div className="grid grid-cols-1 md:grid-cols-2 px-20 py-24 gap-[61px] text-[#282938] w-full bg-[#F4F5F5]">
